...
import com.sr.demo.request.CategoryCreateReq;
...
public class CategoryController {
    ...
    @AdminPermission
    public String create(@Valid CategoryCreateReq categoryCreateReq, BindingResult bindingResult) throws SrException {
