package com.sr.demo.controller.admin;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.sr.demo.common.*;
import com.sr.demo.model.SellerModel;
import com.sr.demo.request.PageQuery;
import com.sr.demo.request.SellerCreateReq;
...
public class SellerController {
    ...
    @AdminPermission
    public String create(@Valid SellerCreateReq sellerCreateReq, BindingResult bindingResult) throws SrException {
    ...
    @AdminPermission
    @ResponseBody
    public CommonRes down(@RequestParam(value="id")Integer id) throws SrException {
    ...
    @AdminPermission
    @ResponseBody
    public CommonRes up(@RequestParam(value="id")Integer id) throws SrException {
